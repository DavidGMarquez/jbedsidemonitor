...
public class CompleteTest {
    ...
    public void testBasicMassiveAlgorithm() {
        ...
        SinTimeSeriesGenerator sinTimeSeriesGenerator = new SinTimeSeriesGenerator(10, 10, 10, "TimeSeries1");
        SerialTimeSeriesSeriesGenerator serialTimeSeriesSeriesGenerator = new SerialTimeSeriesSeriesGenerator(10, 10, 10, "TimeSeries2");
        try {
            Thread.sleep(2000);
