...
public class DataSourceSinTimeSeries extends DataSourceDefault {
    ...
    public DataSourceSinTimeSeries(int delayFirstTime, float frecuency, int limitOfIterations, String nameSignal, int sizeOfIteration, double multiplier) {
    ...
    public String getIdentifier() {
        return "DataSourceSinTimeSeries";
    }
    ...
    public void showConfigurationGui(JFrame jframe) {
        DataSourceSinTimeSeriesGui dataSourceSinTimeSeriesGui = new DataSourceSinTimeSeriesGui(jframe, true, this);
        dataSourceSinTimeSeriesGui.setLocationRelativeTo(jframe);
        dataSourceSinTimeSeriesGui.setVisible(true);
    }
