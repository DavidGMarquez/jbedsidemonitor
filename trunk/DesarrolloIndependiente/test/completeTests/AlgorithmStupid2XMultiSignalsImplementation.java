 ...
 * @author USUARIO
 */
public class AlgorithmStupid2XMultiSignalsImplementation extends AlgorithmDefaultImplementation {

    public AlgorithmStupid2XMultiSignalsImplementation(String identifier, Series signalToWrite, LinkedList<String> timeSeries, LinkedList<String> eventSeries) {
