...
public class TriggerTest {
    ...
    public void testNotifyNewData() {
        ...
        assertFalse(triggerComplete.trigger());
        assertEquals(triggerComplete.getEventSeriesTriggers().get("EventSerie1").getNewEventCount(), 33);
    ...
    public void testGetReaderCallableAndReset() {
        ...
        assertFalse(AuxTestUtilities.compareReaderCallables(readerCallables, expectedResults));
        expectedResults.put("EventSerie2", new ReaderCallableEventSeries("EventSerie2", "AlgorithmOneA", 0, 200));
        assertTrue(AuxTestUtilities.compareReaderCallables(readerCallables, expectedResults));
        ...
        expectedResults.put("EventSerie3", new ReaderCallableEventSeries("EventSerie3", "AlgorithmOneB", 345, 1000));
        ...
        expectedResults.put("EventSerie2", new ReaderCallableEventSeries("EventSerie2", "AlgorithmCompleteA", 0, 330));
        expectedResults.put("TimeSerie2", new ReaderCallableTimeSeries("TimeSerie2", "AlgorithmCompleteA", 0, 330));
        expectedResults.put("EventSerie3", new ReaderCallableEventSeries("EventSerie3", "AlgorithmCompleteA", 0, 231));
        ...
        expectedResults.put("EventSerie2", new ReaderCallableEventSeries("EventSerie2", "AlgorithmCompleteA", 330, 323));
        expectedResults.put("TimeSerie2", new ReaderCallableTimeSeries("TimeSerie2", "AlgorithmCompleteA", 330, 313));
        expectedResults.put("EventSerie3", new ReaderCallableEventSeries("EventSerie3", "AlgorithmCompleteA", 231, 555));
