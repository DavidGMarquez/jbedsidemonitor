...
public class CircularBufferTest {
    ...
    public void write3Numbers() {
        ...
        assertEquals(true, compareArray(buffer.read(0, buffer.getSize()), dataToWrite,
                dataToWrite.length));
    ...
    public void write5NumbersAndCheckIndexold() {
        ...
        boolean result = buffer.write(dataToWrite);
        assertEquals(true, result);
        assertEquals(true, compareArray(buffer.read(0, buffer.getSize()),
    ...
    public void write6RandomNumbersAndCheckIndexold() {
        ...
        assertEquals(true, result);
        assertEquals(true, compareArray(buffer.read(0, buffer.getSize()), dataToWrite, sizetowrite));
        assertEquals(0, buffer.getIndexold());
    }
    ...
    public void testWriteSeveralTimesAndCheckData() {
        ...
        assertEquals(true, compareArray(buffer.read(0, buffer.getSize()), datacompare, buffer.read(0, buffer.getSize()).length));
        assertEquals(3, buffer.getIndexold());
        float[] datacompare2 = {3, 4, 4, 1, 2};
        result = buffer.write(dataToWrite);
        assertEquals(true, compareArray(buffer.read(0, buffer.getSize()), datacompare2, buffer.read(0, buffer.getSize()).length));
    ...
    public void writeManyNumbersAndCheckIndexoldAndLastData() {
        float[] dataToWrite = this.generateArrayWithConsecutiveIntegers(0, 999);
        ...
        dataToWrite = this.generateArrayWithConsecutiveIntegers(-2, 5);
        result = buffer.write(dataToWrite);
        assertEquals(true, result);
        assertEquals(3, buffer.getIndexold());
    ...
    public void simpleRead() {
        ...
        assertEquals(true, compareArray(buffer.read(1, 2), datacompare2, 2));
        assertEquals(true, compareArray(buffer.read(2, 3), datacompare3, 3));
        assertEquals(true, compareArray(buffer.read(4, 3), datacompare4, 3));
    }
    ...
    public void readWhitRandomNumbers() {
        ...
        assertEquals(true, compareArray(array1, buffer.read(0, 5), 5));
        buffer.write(array2);
        assertEquals(1, buffer.getIndexold());
        assertEquals(true, compareArray(array2, buffer.read(5, 5), 5));
        buffer.write(array3);
        assertEquals(6, buffer.getIndexold());
        assertEquals(true, compareArray(array3, buffer.read(1, 5), 5));
    }
    ...
    public float[] generateArrayWithConsecutiveIntegers(int from, int tam) {
        float[] array = new float[tam];
        for (int i = 0; i < tam; i++) {
            array[i] = i + from;
        }
